...
module mysystem_mm_interconnect_1 (
	...
	wire  [112:0] system_console_avalon_jtag_slave_agent_rf_source_data;                // system_console_avalon_jtag_slave_agent:rf_source_data -> system_console_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [112:0] system_console_avalon_jtag_slave_agent_rsp_fifo_out_data;             // system_console_avalon_jtag_slave_agent_rsp_fifo:out_data -> system_console_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [111:0] system_console_avalon_jtag_slave_agent_rp_data;                       // system_console_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> system_console_avalon_jtag_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                    // system_console_avalon_jtag_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                  // cmd_mux:src_channel -> system_console_avalon_jtag_slave_burst_adapter:sink0_channel
	...
	wire  [111:0] system_console_avalon_jtag_slave_burst_adapter_source0_data;          // system_console_avalon_jtag_slave_burst_adapter:source0_data -> system_console_avalon_jtag_slave_agent:cp_data
	...
	wire    [1:0] system_console_avalon_jtag_slave_burst_adapter_source0_channel;       // system_console_avalon_jtag_slave_burst_adapter:source0_channel -> system_console_avalon_jtag_slave_agent:cp_channel
