...
# Wed Feb 17 16:35:52 PST 2016
# DO NOT MODIFY


# 
# sort "sort_component" v1.0
# Team A+ 2016.02.17.16:35:52
# 
# 
...
set_module_property DISPLAY_NAME sort_component
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL sort
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file sort.v VERILOG PATH sort.v TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL sort
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file sort.v VERILOG PATH sort.v
...
add_interface_port control done done Output 1
add_interface_port control length length Input 7
add_interface_port control readaddress readaddress Input 32
add_interface_port control ready ready Input 1
add_interface_port control state state Output 3
add_interface_port control writeaddress writeaddress Input 32
add_interface_port control averageout average Output 16
